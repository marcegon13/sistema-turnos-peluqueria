...
class AppTurnosPeluqueria:
    ...
    def conectar_bd(self):
        try:
            ...
            # Crear tabla turnos con nuevos campos
            self.cursor.execute('''
            ...
            # Migración: agregar columna servicios_manicura si no existe
            try:
                self.cursor.execute("ALTER TABLE turnos ADD COLUMN servicios_manicura TEXT")
                print("✅ Columna servicios_manicura agregada")
            except sqlite3.OperationalError:
                print("✅ Columna servicios_manicura ya existe")
    ...
    def cargar_profesionales(self):
        # Estilistas actualizados con Walter Tejada y Jorgelina Silvero
        self.estilistas = [
    ...
    def selector_fecha(self):
        """Selector de fecha con año y mes"""
    ...
    def buscar_turnos(self):
        """Búsqueda mejorada - busca en todos los campos"""
        ...
        try:
            ...
            if turnos:
                for turno in turnos:
                    fecha_sql = turno[7]  # Índice ajustado por nueva columna
                    try:
                    ...
                    turno_formateado = (
                        ...
                        turno[4], turno[5], turno[6], fecha_mostrar, turno[8]
                    )
    ...
    def crear_componentes(self):
        ...
        # FORMULARIO IZQUIERDA - MÁS ANGOSTO (350px)
        ...
        # Botones del formulario - MÁS COMPACTOS
        ...
        # TABLA DERECHA - MÁS ANCHA (OCUPA ESPACIO RESTANTE)
        ...
        self.tabla = ttk.Treeview(frame_tabla_content, 
                                columns=('ID', 'Nombre', 'Tel', 'Servicios', 'Estilista', 'Manicura', 'ServManicura', 'Fecha', 'Hora'), 
                                show='headings', height=15)

        # COLUMNAS MÁS ANCHAS PARA MEJOR VISUALIZACIÓN
        columnas = [
            ('ID', 40),
            ('Nombre', 150),      # Más ancho para nombres
            ('Tel', 100),
            ('Servicios', 120),
            ('Estilista', 130),   # Más ancho para estilistas
            ('Manicura', 100),
            ('ServManicura', 120),
            ('Fecha', 80),
            ('Hora', 60)          # Más ancho para hora
        ]
        ...
        btn_eliminar = self.crear_boton_redondeado(frame_footer, 'ELIMINAR', self.estilos['peligro'], self.eliminar_turno, width=12)
        btn_eliminar.pack()
    ...
    def agregar_turno(self):
        ...
        # CAMPOS OBLIGATORIOS: Nombre, Teléfono, Estilista, Manicura, Fecha, Hora
